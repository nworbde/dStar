program test_constants
	...
	call do_one('amu',amu)
	call do_one('amu*NA-1',amu*avogadro-1.0_dp)
	...
	call do_one('e**2/(hbar*c)/alpha-1',electroncharge**2/hbar/clight/finestructure-1.0_dp)
	...
	call do_one('a_Bohr/a_Bohr(CODATA)-1',a_Bohr/0.52917721092e-8_dp - 1.0_dp)
	call do_one('Rydberg',Rydberg)
	call do_one('Rydberg/CODATA - 1',2.0_dp*Rydberg/4.35974434e-11_dp - 1.0_dp)
	...
	subroutine do_one(name,val)
		character(len=*), parameter :: fmt = '(a24," = ",es20.13)'
