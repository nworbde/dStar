...
contains
    ...
    subroutine get_thermal_conductivity(rho,T,chi,Gamma,eta,ionic,K,use_pcy,use_page,which_components)
        ...
        call conductivity(rho,T,chi,Gamma,eta,ionic,K,which_ee,which_eQ,K_components)
