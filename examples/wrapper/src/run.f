program run_dStar
    ...
    character(len=*), parameter :: default_Q_heating_shallow = '0.0'
    character(len=64) :: my_dStar_dir
    character(len=64) :: inlist
    character(len=64) :: Q_heating_shallow_arg
    real(dp) :: Q_heating_shallow
    real(dp) :: eV_to_MK
...
!     write(output_unit,'(a,f4.1,a)') 'Q shallow = ',s% Q_heating_shallow,' MeV'
